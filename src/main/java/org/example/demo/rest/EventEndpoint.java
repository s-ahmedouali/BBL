...
import org.example.demo.model.Event;
...
public class EventEndpoint
{
   ...
   {
      TypedQuery<Event> findByIdQuery = em.createQuery("SELECT DISTINCT e FROM Event e LEFT JOIN FETCH e.talkers LEFT JOIN FETCH e.participants WHERE e.id = :entityId ORDER BY e.id", Event.class);
   ...
   {
      TypedQuery<Event> findAllQuery = em.createQuery("SELECT DISTINCT e FROM Event e LEFT JOIN FETCH e.talkers LEFT JOIN FETCH e.participants ORDER BY e.id", Event.class);
