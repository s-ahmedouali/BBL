...
public class UserEndpoint
{
   ...
   {
      TypedQuery<User> findByIdQuery = em.createQuery("SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.detail WHERE u.id = :entityId ORDER BY u.id", User.class);
   ...
   {
      TypedQuery<User> findAllQuery = em.createQuery("SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.detail ORDER BY u.id", User.class);
